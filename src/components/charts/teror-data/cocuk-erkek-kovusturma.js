...
const CocukErkekKovusturma = () => {
    ...
    const columns = [
        { name: 'Karar', selector: row => row[15], sortable: true, grow: 1 },
        { 
            name: '18 yaş altı erkekler', 
    ...
    const customStyles = {
        ...
        headCells: {
            style: {
                ...
                background: 'linear-gradient(to right, #12175f, #0c1685 )',
                color: '#FFF', 
                fontSize: '12px', 
            },
        },
    ...
    return (
        <div>
            <p style={{ fontWeight: 'bold' }}>18 Yaş Altı Erkeklere Yönelik Yürütülen Kovuşturma İstatistiği</p>
            <DataTable
                columns={columns}
                data={dataRows}
                highlightOnHover
...
export default CocukErkekKovusturma;
