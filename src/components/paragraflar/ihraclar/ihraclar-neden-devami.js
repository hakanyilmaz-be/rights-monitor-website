  ...
  return (
    <>
      <p className="small-paragraph">
        ...
        hakkında ise soruşturma başlatılmıştır. Bu yolla basta Gülen Hareketi
        mensupları olmak üzere muhalifler için içinden çıkmaları mümkün olmayan
        kısır bir döngü kurulmustur.
      </p>
    </>
  );
};
