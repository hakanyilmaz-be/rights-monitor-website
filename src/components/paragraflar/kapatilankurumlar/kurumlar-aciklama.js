  ...
  return (
    <>
      ...
      <p className="small-paragraph">
        15 Temmuz ardından kapatılan ve el konulan kurumlar, iktidar ve
        yanlıları tarafından farklı amaçlarla kullanılmaya başlandı. İzmir Şifa
        ...
        adliye binasına dönüştürüldü.
      </p>
      <p className="small-paragraph">
        Benzer şekilde, Zaman Gazetesi’nin İstanbul’daki merkez binası Bakırköy
        Adliyesi Ek Binası olarak kullanılmaya başlandı. Gülen Hareketi’ne ait
